...
stanford_ner_name = 'stanford-ner-2018-02-27'
    ...
    def __init__(self, override=False,lang='en'):
        ...
        if lang == 'zh':
            ...
            ner = NonTokenizingNERTagger(
                os.path.join(ner_path, 'classifiers', 'chinese.misc.distsim.crf.ser.gz'),
...
def download(lang='en'):
    ...
    try:
        ...
        print("Stanford NER is already downloaded and functional.")
