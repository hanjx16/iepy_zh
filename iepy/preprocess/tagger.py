...
stanford_postagger_name = 'stanford-postagger-full-2017-06-09'
...
class StanfordTaggerRunner(TaggerRunner):
    ...
    def __init__(self, override=False,lang='en'):
        ...
        if lang =='zh':
            # TODO   this should change for chinese
...
def download(lang='en'):
    ...
    try:
        StanfordTaggerRunner(lang=lang)
    except LookupError:
        ...
        print("Stanford POS tagger is already downloaded and functional.")
